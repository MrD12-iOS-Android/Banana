...
class ViewController_2: UIViewController {
    ...
    var bir = Banans(one: 2, two: 2, variantlar: [4,5,1,7])
    var ikki = Banans(one: 3, two: 3, variantlar: [3,1,5,6])
    var uch = Banans(one: 3, two: 1, variantlar: [10,4,9,2])
    var tort = Banans(one: 1, two: 3, variantlar: [4,3,1,7])
    var besh = Banans(one: 1, two: 1, variantlar: [2,5,1,9])
    var olti = Banans(one: 3, two: 2, variantlar: [4,5,11,71])
    var yetti = Banans(one: 2, two: 2, variantlar: [4,5,11,7])
    var sakkiz = Banans(one: 1, two: 2, variantlar: [3,5,1,7])
