...
class Pear: UIViewController {
    ...
    var bir = Pears(one: 2, two: 2, variantlar: [4,5,1,7])
    var ikki = Pears(one: 3, two: 3, variantlar: [3,1,5,6])
    var uch = Pears(one: 3, two: 1, variantlar: [0,4,9,2])
    var tort = Pears(one: 1, two: 3, variantlar: [4,3,1,7])
    var besh = Pears(one: 1, two: 1, variantlar: [2,5,1,9])
    var olti = Pears(one: 3, two: 2, variantlar: [4,5,1,7])
    var yetti = Pears(one: 2, two: 2, variantlar: [4,5,2,7])
    var sakkiz = Pears(one: 1, two: 2, variantlar: [3,5,1,7])
