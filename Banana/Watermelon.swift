...
class Watermelon: UIViewController {
    ...
    var array : [Watermelons] = []
    var joriy_savol = 0
    var hisob_next = 0
    var natija_hisob = 0
    var over_hisob = 0
    
    var bir = Watermelons(one: 2, two: 2, variantlar: [4,5,1,7])
    var ikki = Watermelons(one: 3, two: 3, variantlar: [3,1,5,6])
    var uch = Watermelons(one: 3, two: 1, variantlar: [10,4,9,2])
    var tort = Watermelons(one: 1, two: 3, variantlar: [4,3,1,7])
    var besh = Watermelons(one: 1, two: 1, variantlar: [2,5,1,9])
    var olti = Watermelons(one: 3, two: 2, variantlar: [4,5,11,71])
    var yetti = Watermelons(one: 2, two: 2, variantlar: [4,5,11,7])
    var sakkiz = Watermelons(one: 1, two: 2, variantlar: [3,5,1,7])
